...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim practice, technique work, and occasional meets",
    ...
    "Debate Club": {
        "description": "Practice formal debate formats and public speaking",
    ...
    "Science Club": {
        ...
        "max_participants": 20,
        "participants": ["oliver@mergington.edu", "riley@mergington.edu"]
    }
}
...
@app.post("/activities/{activity_name}/participants/remove")
